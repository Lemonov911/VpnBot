...
T: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "bot_grace_notice":             "⏳ <b>Подписка истекла — VPN работает на 1 Мбит/с 14 дней</b>\n\nПродли в Mini App, чтобы вернуть полную скорость.",
        ...
        "bot_referral_reactivate_title": "🎁 <b>Бонусные дни активированы! VPN {plan} вернулся.</b>",
        ...
        "bot_purchase_success_partial": "⚙️ Слотов готово: {delivered}/{total}. Остальные активируй кнопкой «+» в Mini App → Конфиги; если не выйдет — напиши в поддержку.",
        ...
        "bot_lava_charge_failed":       "⚠️ <b>Не удалось продлить подписку</b>\n\nLava не смогла списать оплату с карты. Lava попробует ещё раз через сутки. Если не получится — VPN перейдёт в режим 1 Мбит/с на 14 дней.\n\nПроверь баланс карты или оплати вручную через меню.",
        ...
        "bot_grace_3d":
            ...
            "Подписка в режиме 1 Мбит/с — а через 3 дня закроется совсем. "
        ...
        "trial_success_awg":
            ...
            "<b>1) AmneziaWG</b> — главный обфускатор\n"
    ...
    "en": {
        ...
        "bot_grace_notice":             "⏳ <b>Subscription expired — VPN throttled to 1 Mbps for 14 days</b>\n\nRenew in Mini App to restore full speed.",
        ...
        "bot_referral_reactivate_title": "🎁 <b>Bonus days redeemed! VPN {plan} is back.</b>",
        ...
        "bot_purchase_success_partial": "⚙️ Configs ready: {delivered}/{total}. Activate the rest via the «+» button in Mini App → Configs; if it doesn't work, contact support.",
        ...
        "bot_lava_charge_failed":       "⚠️ <b>Could not renew subscription</b>\n\nLava could not charge your card. Lava will retry in 24h. If it fails — VPN will throttle to 1 Mbps for 14 days.\n\nCheck your card balance or pay manually via menu.",
        ...
        "bot_grace_3d":
            ...
            "Subscription is throttled to 1 Mbps — and in 3 days it will close completely. "
        ...
        "trial_success_awg":
            ...
            "<b>1) AmneziaWG</b> — main obfuscator\n"
