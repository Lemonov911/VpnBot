...
const T = {
  ru: {
    ...
    instr_step1:         'Установи приложение',
    instr_step1_sub:     'Happ — для основной VLESS-подписки',
    instr_step2:         'Импортируй ссылку',
    instr_step2_sub:     'Из «Мои конфиги» → «Копировать»',
    instr_step3:         'Включи переключатель',
    instr_step3_sub:     'Выбери локацию и подключайся',
  ...
  en: {
    ...
    instr_step1:         'Install the app',
    instr_step1_sub:     'Happ — for the main VLESS subscription',
    instr_step2:         'Import the link',
    instr_step2_sub:     'From «My configs» → «Copy»',
    instr_step3:         'Toggle the switch on',
    instr_step3_sub:     'Pick a location and connect',
