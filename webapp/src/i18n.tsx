...
const T = {
  ru: {
    ...
    vpn_grace_banner_body:  'Скорость снижена до 1 Мбит/с — Telegram и почта работают, видео и игры тормозят. Осталось {plural} — успей продлить, иначе доступ закроется.',
    ...
    plans_updating:'Обновляем подписку…',
    plans_month:   '/ мес',
    ...
    support_too_many_videos: 'Можно прикрепить только одно видео',
    support_file_too_large:  'Файл больше 5 МБ',
    support_video_too_large: 'Видео больше 10 МБ',
    support_total_too_large: 'Суммарный размер больше 30 МБ',
    support_unsupported_type:'Поддерживаются JPEG/PNG/WebP/HEIC и MP4/MOV',
    ...
    // Paid-only gate (показывается юзерам без активной платной подписки)
    ref_locked_title: 'Реферальная программа доступна с подпиской',
    ref_locked_sub:   'Чтобы приглашать друзей и зарабатывать бонусные дни, нужна активная платная подписка.',
    ref_locked_btn:   'Купить подписку',
    // «Мои бонусы» — bank накопленных дней + redeem кнопка
    ref_my_bonuses:        'Мои бонусы',
    ref_my_bonuses_label:  'Бонусных дней накоплено',
    ref_my_bonuses_hint_active:     'Нажми «Активировать» чтобы добавить их к текущей подписке.',
    ref_my_bonuses_hint_no_sub:     'Бонусы применяются к активной подписке — продли чтобы активировать.',
    ref_my_bonuses_hint_reactivate: 'Подписка истекла — нажми «Активировать», бонусы вернут её на {days} дн.',
    ref_my_bonuses_hint_empty:      'Пригласи друга — за каждого, кто купит VPN, ты получишь +7 дней в банк.',
    ref_redeem_btn:             'Активировать +{days} дней',
    ref_redeem_btn_reactivate:  'Активировать +{days} (вернёт подписку)',
    ref_redeem_btn_no_sub:      'Купи подписку чтобы активировать',
    ref_redeem_btn_empty:       'Пока нечего активировать',
    ref_redeem_no_sub:          'Нужна активная подписка для активации бонусов.',
    ref_redeem_no_eligible_sub: 'Сначала купи подписку — тогда сможешь применить накопленные бонусы.',
    ref_redeem_done:            '🎁 +{days} дней активированы. Подписка до {date}.',
    ref_redeem_done_reactivate: '🎁 Подписка возвращена на {days} дн. (до {date})! Активируй слоты в разделе VPN.',
    ref_redeem_err:             'Не получилось активировать — попробуй позже или напиши в поддержку.',

    // VPN page extras
    vpn_server_subtitle:  'до 120 Мбит/с',
    vpn_no_data:           'нет данных',
    vpn_plan_base:         'База',
    vpn_plan_base_3m:      'База · 3 мес',
    vpn_plan_base_6m:      'База · 6 мес',
    vpn_plan_base_12m:     'База · 1 год',
    vpn_plan_max:          'Макс',
    vpn_plan_max_3m:       'Макс · 3 мес',
    vpn_plan_max_6m:       'Макс · 6 мес',
    vpn_plan_max_12m:      'Макс · 1 год',
    vpn_plan_trial:        '🎁 Пробный',
    vpn_plan_start:        'Старт',
    vpn_plan_popular:      'Популярный',
    vpn_plan_pro:          'Про',
    vpn_plan_family:       'Семейный',
    vpn_payment_error:     'Ошибка оплаты. Попробуйте ещё раз.',
    ...
    home_pending_next:     'Со след. периода:',
    ...
    configs_server_offline:'Сервер недоступен — пересоздай конфиг',
    configs_soon:          'Скоро',
    ...
    pay_trial_warning:   'У тебя активен пробный период — при покупке он закроется, и сразу начнётся платный период. Оставшиеся бесплатные дни не переносятся.',
    ...
    vpn_autorenew_off_until: 'VPN работает до {date} (без автопродления)',
    // FFF4: warning когда Lava recurring charge не прошёл (нет денег / просрочена карта).
    // Lava ретраит через сутки — показываем юзеру до retry чтобы он успел исправить.
    vpn_charge_failed_title: '⚠️ Не удалось списать с карты',
    ...
    cancel_renewal_keeps_hint:     'После этой даты — обычный grace-период (1 Мбит/с на 14 дней), затем подписка истечёт.',
    ...
    home_trial_badge:  'Триал',
    home_trial_card_note: 'Бесплатный пробный — выбери постоянный тариф пока триал ещё активен',
    home_trial_buy_cta:   'Выбрать тариф',
    home_expired_badge:   'Истекла',
    home_expired_ago_prefix: 'Истекла',
    home_expired_ago_suffix: 'назад',
    home_expired_card_note: 'Подписка истекла — продли, чтобы вернуть полную скорость',
    home_expired_buy_cta:   'Продлить тариф',
    configs_grace_title:    '⏳ Подписка истекла — VPN работает на 1 Мбит/с',
    configs_grace_sub:      'Продли в Mini App → VPN, чтобы вернуть полную скорость.',
    configs_grace_until:    'Полное отключение',
    configs_grace_days_left_1: 'день',
    configs_grace_days_left_2: 'дня',
    configs_grace_days_left_5: 'дней',
    ...
    trial_success_title:  '🎉 Пробный период активирован!',
    ...
    trial_later:          'Разберусь позже',
    trial_install_label:  'Установить',
    trial_configs_hint:   'Скачать AWG‑файл и VLESS‑ссылку',
    trial_err_active:     'У тебя уже есть активная подписка.',
    trial_err_used:       'Пробный период уже использован раньше.',
    ...
    home_invite_progress: 'Друзей пригласил: {invited} → +{bonus} дн',
    home_invite_progress_sub: 'Жду первой оплаты твоего друга → +7 дней',
    home_invite_progress_sub_with_converts: '{converted} уже оформили подписку',
    home_until:        'до',
  ...
  en: {
    ...
    vpn_grace_banner_body:  'Speed throttled to 1 Mbps — Telegram and email still work, video and games lag. {plural} left — renew now, otherwise access will be cut off.',
    ...
    plans_updating:'Updating subscription…',
    plans_month:   '/ mo',
    ...
    support_too_many_videos: 'Only one video can be attached',
    support_file_too_large:  'File over 5 MB',
    support_video_too_large: 'Video over 10 MB',
    support_total_too_large: 'Total over 30 MB',
    support_unsupported_type:'Supported: JPEG/PNG/WebP/HEIC and MP4/MOV',
    ...
    ref_locked_title: 'Referral program requires a subscription',
    ref_locked_sub:   'To invite friends and earn bonus days, you need an active paid subscription.',
    ref_locked_btn:   'Buy subscription',
    ref_my_bonuses:        'My Bonuses',
    ref_my_bonuses_label:  'Bonus days accumulated',
    ref_my_bonuses_hint_active:     'Tap «Activate» to add them to your current subscription.',
    ref_my_bonuses_hint_no_sub:     'Bonuses apply to active subscription — renew to activate.',
    ref_my_bonuses_hint_reactivate: 'Subscription expired — tap «Activate» to bring it back for {days} days.',
    ref_my_bonuses_hint_empty:      'Invite a friend — for each one who buys VPN you get +7 days into your bank.',
    ref_redeem_btn:             'Activate +{days} days',
    ref_redeem_btn_reactivate:  'Activate +{days} (brings sub back)',
    ref_redeem_btn_no_sub:      'Buy subscription to activate',
    ref_redeem_btn_empty:       'Nothing to activate yet',
    ref_redeem_no_sub:          'Active subscription needed to activate bonuses.',
    ref_redeem_no_eligible_sub: 'Buy a subscription first — then you can use accumulated bonuses.',
    ref_redeem_done:            '🎁 +{days} days activated. Subscription until {date}.',
    ref_redeem_done_reactivate: '🎁 Subscription brought back for {days} days (until {date})! Activate slots in VPN section.',
    ref_redeem_err:             'Could not activate — try again later or contact support.',

    // VPN page extras
    vpn_server_subtitle:  'up to 120 Mbps',
    vpn_no_data:           'no data',
    vpn_plan_base:         'Base',
    vpn_plan_base_3m:      'Base · 3mo',
    vpn_plan_base_6m:      'Base · 6mo',
    vpn_plan_base_12m:     'Base · 1y',
    vpn_plan_max:          'Max',
    vpn_plan_max_3m:       'Max · 3mo',
    vpn_plan_max_6m:       'Max · 6mo',
    vpn_plan_max_12m:      'Max · 1y',
    vpn_plan_trial:        '🎁 Trial',
    vpn_plan_start:        'Starter',
    vpn_plan_popular:      'Popular',
    vpn_plan_pro:          'Pro',
    vpn_plan_family:       'Family',
    vpn_payment_error:     'Payment error. Please try again.',
    ...
    configs_server_offline:'Server offline — recreate config',
    configs_soon:          'Soon',
    configs_add_btn:       '+ Add',
    configs_copy:          'Copy',
    ...
    vpn_autorenew_off_until: 'VPN active until {date} (no auto-renewal)',
    vpn_charge_failed_title: '⚠️ Could not charge your card',
    ...
    home_trial_badge:  'Trial',
    home_trial_card_note: "Free trial — pick a permanent plan while it's still active",
    home_trial_buy_cta:   'Choose plan',
    home_expired_badge:   'Expired',
    home_expired_ago_prefix: 'Expired',
    home_expired_ago_suffix: 'ago',
    home_expired_card_note: 'Subscription expired — renew to restore full speed',
    home_expired_buy_cta:   'Renew plan',
    configs_grace_title:    '⏳ Subscription expired — VPN is throttled to 1 Mbps',
    configs_grace_sub:      'Renew in Mini App → VPN to restore full speed.',
    configs_grace_until:    'Full disconnect',
    configs_grace_days_left_1: 'day',
    configs_grace_days_left_2: 'days',
    configs_grace_days_left_5: 'days',
    ...
    trial_later:          'Maybe later',
    trial_install_label:  'Install',
    trial_configs_hint:   'Download AWG file and VLESS link',
    ...
    home_invite_progress: 'Invited friends: {invited} → +{bonus}d',
    home_invite_progress_sub: 'Waiting for your friend\'s first payment → +7 days',
    home_invite_progress_sub_with_converts: '{converted} already subscribed',
    home_until:        'until',
