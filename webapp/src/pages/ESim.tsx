        ...
        <>
          <div className="bg-[var(--tg-theme-section-bg-color)] border border-[var(--card-border)] rounded-2xl overflow-hidden">
            {[
              ...
              <div key={i} className={`py-[13px] px-4 flex items-start gap-[14px] ${i < arr.length - 1 ? 'border-b border-solid border-[var(--card-border)]' : ''}`}>
          ...
          {ruEntry && (
            <div className="bg-[var(--tg-theme-section-bg-color)] border border-[var(--card-border)] rounded-2xl overflow-hidden">
              <div
                ...
                className="py-[13px] px-4 flex items-start gap-[14px] cursor-pointer"
              >
          ...
          >
            <div className="py-[13px] px-4 flex items-start gap-[14px]">
              <div className="w-9 h-9 rounded-[10px] shrink-0 bg-warning flex items-start justify-center">
          ...
          <div className="bg-[var(--tg-theme-section-bg-color)] border border-[var(--card-border)] rounded-2xl overflow-hidden">
            {travelCountries.map((c, i) => (
              <div
                ...
                className={`py-[13px] px-4 flex items-start gap-[14px] cursor-pointer ${i < travelCountries.length - 1 ? 'border-b border-solid border-[var(--card-border)]' : ''}`}
              >
